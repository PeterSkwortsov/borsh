  ...
  return (
    <>
      ...
      <p className="flex text-center justify-center p-3 md:max-w-1/2 m-auto">
        ...
        можете создать небольшую кружку, тарелку или вазочку, а на ручной лепке
        можем предложить размеры больше и более сложные изделия, такие как,
        например, менажница.
      </p>
                ...
                <div className="flex flex-row items-start">
                  <div className="bg-orange-100 p-5 px-10 w-full flex items-center">
                    <p className="text-gray-700 text-md">
                      ...
                      <br></br>В среднем ваши изделия будут готовы через четыре
                      недели. Это стандартный срок для большинства мастерских,
