          ...
          <div className="grid items-center grid-cols-1 md:grid-cols-2">
            <div className="px-4">
              ...
              <p className="max-w-sm mt-3 text-md leading-relaxed text-black md:mt-8">
                ...
                на седьмом небе от счастья, ведь теперь у нас будет НАСТОЯЩИЙ
                ...
                <br></br>
                <br></br>
                Этой студией я обязана своему учителю, которая поверила в меня.
                Теперь я сама понимаю, как важен учитель в жизни каждого ребенка
                и как от его действий зависит порой чье-то будущее.
              </p>
