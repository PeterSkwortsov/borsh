          ...
          <div className="mockup-phone-display w-full h-full">
            <div className="chat chat-start bg-gray-200">
              ...
              <div className="chat-bubble bg-black text-white text-sm max-sm:text-sm max-md:text-md">
                Смотри! Я нашла место, где свободна в выборе творчесва, тут меня
                направляют и помогают сформировать мои идеи в цельный образ.
                <br></br>
                Это мотивирует меня на создание более сложных проектов!
              </div>
            </div>
