              ...
              <div className=" text-neutral-content text-center pl-0 pr-0">
                <div className="hero-overlay rounded-4xl p-8">
                  <h3 className="mb-5 pt-3 pb-0 cursor-default font-light  max-sm:text-base  max-lg:text-lg max-xl:text-xl  max-2xl:text-2xl">
                    Меня зовут Иван Петров. Родился 15 марта 1990 года в Москве.
                    В семье было трое детей, я был средним. В детстве увлекался
                    рисованием и спортом.<br></br>Получив образование в средней
                    школе, поступил в Московский государственный университет на
                    факультет журналистики. Позже начал работать в местной
                    газете, что подтолкнуло меня к написанию статей и отчётов
                    <br></br>
                    На данный момент работаю freelance-журналистом и веду блог о
                    современных трендах. В свободное время увлекаюсь фотографией
                    и путешествиями. В будущем планирую продолжить карьеру в
                    медиа и написать свою книгу, основанную на личном опыте.
                  </h3>
