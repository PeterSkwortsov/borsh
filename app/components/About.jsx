            ...
            <div className=" text-neutral-content text-center pl-0 pr-0">
              <div className="hero-overlay rounded-4xl p-4">
                <h3 className="mb-5 pt-3 pb-0 cursor-default font-light  max-sm:text-base  max-lg:text-lg max-xl:text-xl  max-2xl:text-2xl text-ellipsis  ">
                  <p className='font-bold p-0 m-0'>Здравствуйте! Меня зовут Виктория Скворцова.</p> <br></br>Родилась в
                  небольшом поселке Ломовка. С детства увлекалась рисованием, но
                  к сожалению ни художественной школы, ни кружка в этом направлении не
                  было. И любовь к рисованию так и могла остаться лишь
                  увлечением и хобби...<br></br>
                  ...
                  я работала в школе учителем изобразительного искусства. А с 2023
                  года преподавала в школе рисования.
                  <br></br>
                  <br></br>
