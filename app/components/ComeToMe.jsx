          ...
          <div>
            ...
            <ul className="list-disc pr-1 pl-5">
              <li className="mt-5 pb-2">
                Хотите узнаете о различных техниках и стилях рисования,
              ...
              <li className="pb-2 ">
                Нужна практика и совершенствование имеющихся навыков. Чем больше вы будете
                практиковаться, тем увереннее будете чувствовать себя для рещения своих задач.
              </li>
